...
function EditForm({submitFunction, isActive}) {
  ...
  return (
    ...
    >
      {() => (  //errors, touched and other usefull methods of useFormik
        <Form className={isActive ? styles.form : `${styles.form} ${styles.form_inactive}`}>
          <fieldset className={styles.activeWrapper} disabled={!isActive}>
